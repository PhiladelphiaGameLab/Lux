...
public:
	...
	*/
	void sendTo(const void *buffer, int bufferLen, const struct sockaddr_in *cli_addr) throw(SocketException);
	...
	*/
	int recvFrom(void *buffer, int bufferLen, struct sockaddr_in* cli_addr) throw(SocketException);
