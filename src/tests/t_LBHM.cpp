...
bool test2 (HMBL<int> data){
	std::list<LocData<int> >* t1 = getSocketLists(HashUtil::LBHM2Input(MapLocationDS{2,7,4,5});
	std::list<LocData<int> > t2 = getIndex(HashUtil::LBHM2Input(MapLocationDS{2,7,4,5});
...
//TESTS GETTING FROM THE LIST
bool test2a (HMBL<std::string> data){
	std::list<LocData<std::string> >* t1 = getSocketLists(HashUtil::LBHM2Input(MapLocationDS{2,7,4,5});
	std::list<LocData<std::string> > t2 = getIndex(HashUtil::LBHM2Input(MapLocationDS{2,7,4,5});
